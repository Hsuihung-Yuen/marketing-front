...
export default function Home() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#e7305e]"
            ...
            {/* 头部文案 */}
            <header className="text-6xl font-bold text-center text-gray-800 my-8" style={{color: "white"}}>
                抽奖营销系统平台展示
            </header>
            ...
            <footer className="text-gray-600 text-center my-8" style={{color: "white"}}>
                <div>@author: Hhy</div>
                <div>@github:
                    <a href="https://github.com/Hsuihung-Yuen" target="_blank" color={"#0092ff"}>Hsuihung-Yuen</a>
                </div>
            </footer>
        </div>
    );
